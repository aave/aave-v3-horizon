...
contract MainnetTest is Test {
  ...
  //   IPool pool = IPool(0xAe05Cd22df81871bc7cC2a04BeCfb516bFe332C8);
  //   address USTB_ADDRESS = 0x43415eB6ff9DB7E26A15b704e7A3eDCe97d31C4e;
  //   DataTypes.ReserveConfigurationMap memory config = pool.getConfiguration(USTB_ADDRESS);
  //   console.log('USTB_ADDRESS paused: ', config.getPaused());
  //   console.log(
  //     'USCC_ADDRESS paused: ',
  //     pool.getConfiguration(0x14d60E7FDC0D71d8611742720E4C50E7a974020c).getPaused()
  //   );
  //   console.log(
  //     'USYC_ADDRESS paused: ',
  //     pool.getConfiguration(0x136471a34f6ef19fE571EFFC1CA711fdb8E49f2b).getPaused()
  //   );
  //   console.log(
  //     'JTRSY_ADDRESS paused: ',
  //     pool.getConfiguration(0x8c213ee79581Ff4984583C6a801e5263418C4b86).getPaused()
  //   );
  //   console.log(
  //     'JAAA_ADDRESS paused: ',
  //     pool.getConfiguration(0x5a0F93D040De44e78F251b03c43be9CF317Dcf64).getPaused()
  //   );
  //   console.log(
  //     'RLUSD_ADDRESS paused: ',
  //     pool.getConfiguration(0x8292Bb45bf1Ee4d140127049757C2E0fF06317eD).getPaused()
  //   );
  //   console.log(
  //     'GHO_ADDRESS paused: ',
  //     pool.getConfiguration(0x40D16FC0246aD3160Ccc09B8D0D3A2cD28aE6C2f).getPaused()
  //   );
  //   console.log(
  //     'USDC_ADDRESS paused: ',
  //     pool.getConfiguration(0xA0b86991c6218b36c1d19D4a2e9Eb0cE3606eB48).getPaused()
  //   );
  //   console.log(vm.getBlockTimestamp());
  // }

  function test_supply_ustb() public {
    IPool pool = IPool(0xAe05Cd22df81871bc7cC2a04BeCfb516bFe332C8);
    IERC20Detailed USTB_ADDRESS = IERC20Detailed(0x43415eB6ff9DB7E26A15b704e7A3eDCe97d31C4e);
    address user = 0xE9a2dCf621186F412685828d2D2b90c688D31aD5;

    vm.startPrank(user);
    USTB_ADDRESS.approve(address(pool), 1e10);
    pool.supply(address(USTB_ADDRESS), 1e10, user, 0);
    vm.stopPrank();
  }

  function test_supply_uscc() public {
    IPool pool = IPool(0xAe05Cd22df81871bc7cC2a04BeCfb516bFe332C8);
    IERC20Detailed USCC_ADDRESS = IERC20Detailed(0x14d60E7FDC0D71d8611742720E4C50E7a974020c);
    address user = 0xE9a2dCf621186F412685828d2D2b90c688D31aD5;

    vm.startPrank(user);
    USCC_ADDRESS.approve(address(pool), 1e10);
    pool.supply(address(USCC_ADDRESS), 1e10, user, 0);
    vm.stopPrank();
  }

  function test_supply_usyc() public {
    IPool pool = IPool(0xAe05Cd22df81871bc7cC2a04BeCfb516bFe332C8);
    IERC20Detailed USYC_ADDRESS = IERC20Detailed(0x136471a34f6ef19fE571EFFC1CA711fdb8E49f2b);
    address user = 0xE9a2dCf621186F412685828d2D2b90c688D31aD5;

    vm.startPrank(user);
    USYC_ADDRESS.approve(address(pool), 1e10);
    pool.supply(address(USYC_ADDRESS), 1e10, user, 0);
    vm.stopPrank();
  }

  function test_supply_jaaa() public {
    IPool pool = IPool(0xAe05Cd22df81871bc7cC2a04BeCfb516bFe332C8);
    IERC20Detailed JAAA_ADDRESS = IERC20Detailed(0x5a0F93D040De44e78F251b03c43be9CF317Dcf64);
    address user = 0xE9a2dCf621186F412685828d2D2b90c688D31aD5;

    vm.startPrank(user);
    JAAA_ADDRESS.approve(address(pool), 1e10);
    pool.supply(address(JAAA_ADDRESS), 1e10, user, 0);
    vm.stopPrank();
  }

  function test_jtrsy() public {
    address root = 0x0C1fDfd6a1331a875EA013F3897fc8a76ada5DfC;
    address jtrsyAToken = 0x844f07AB09aa5dBDCE6A9b1206CE150E1eaDacCb;
    (bool success, bytes memory data) = root.call(
      abi.encodeWithSignature('endorsed(address)', jtrsyAToken)
    );

    // console.log('success: ', success);
    // console.log('data: ', data);

    bool endorsed = abi.decode(data, (bool));
    console.log('endorsed: ', endorsed);
  }

  function test_jtrsy_user() public {
    address root = 0x0C1fDfd6a1331a875EA013F3897fc8a76ada5DfC;
    address jtrsyAToken = 0xE9a2dCf621186F412685828d2D2b90c688D31aD5;
    (bool success, bytes memory data) = root.call(
      abi.encodeWithSignature('endorsed(address)', jtrsyAToken)
    );
  ...
  function test_supply_jtrsy() public {
    IPool pool = IPool(0xAe05Cd22df81871bc7cC2a04BeCfb516bFe332C8);
    IERC20Detailed JTRSY_ADDRESS = IERC20Detailed(0x8c213ee79581Ff4984583C6a801e5263418C4b86);
    address user = 0xE9a2dCf621186F412685828d2D2b90c688D31aD5;

    console.log('JTRSY_ADDRESS balanceOf user: ', JTRSY_ADDRESS.balanceOf(user));

    vm.startPrank(user);
    JTRSY_ADDRESS.approve(address(pool), 1e6);
    pool.supply(address(JTRSY_ADDRESS), 1e6, user, 0);
    vm.stopPrank();
  }
}
